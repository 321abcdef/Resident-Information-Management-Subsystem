  ...
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Heat Map</h1>
          {/* <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Demographic Overview</p> */}
        </div>

        {/* Category Filters */}
        <div className="flex bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-1 rounded-2xl shadow-sm">
      ...
      {/* Main Grid Container */}
      <AnalyticsCard title="Purok Overview">
        <div className="relative -mt-4"> {/* Negative margin to pull the big gap */}
          
          {/* Legend and Subheader */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {displayData.map((p, i) => (
              <div 
                ...
                className={`p-6 rounded-[2rem] border transition-all cursor-pointer hover:scale-[1.03] ${getBoxStyle(p.currentCount)}`}
              >
      ...
      {/* Recommended Action & Employment Status */}
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3 bg-slate-900 border border-slate-800 text-white p-8 rounded-[2.5rem] flex flex-col justify-between shadow-xl">
          <div>
