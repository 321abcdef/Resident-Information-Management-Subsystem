          ...
          <div className={`w-full max-w-2xl rounded-[32px] md:rounded-[40px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 ${isDarkMode ? "bg-slate-900 border border-white/10" : "bg-white"}`}>
            <div className="relative h-56 md:h-80 w-full overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <span className={`text-[8px] font-black px-3 py-1 rounded-full uppercase tracking-widest mb-3 inline-block shadow-lg ${selectedNews.urgent ? "bg-red-600 text-white" : "bg-emerald-600 text-white"}`}>
                  {selectedNews.tag}
                </span>
            ...
            <div className="p-8 md:p-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[8px] font-black uppercase opacity-40 tracking-widest">Share this update:</span>
              </div>

              <div className={`text-sm md:text-base leading-relaxed mb-8 max-h-[180px] overflow-y-auto pr-4 custom-scrollbar ${isDarkMode ? "text-slate-400" : "text-slate-700"}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex flex-1 gap-2">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl border transition-all hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] ${isDarkMode ? "border-white/10 text-white bg-white/5" : "border-black/5 text-slate-900 bg-slate-50"}`}
                  ...
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(`${selectedNews.title} - ${window.location.href}`);
                      alert("Link copied to clipboard!");
                    }}
                    className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl border transition-all hover:bg-emerald-600 hover:text-white hover:border-emerald-600 ${isDarkMode ? "border-white/10 text-white bg-white/5" : "border-black/5 text-slate-900 bg-slate-50"}`}
                    title="Copy Link"
                  >
                    <Send size={16} />
